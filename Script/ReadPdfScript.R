...
#library(readxl)
#library(textreadr)
#tesseract_download("spa") #ojo
#Cargar la data
setwd("D:/Git Hub-BEST/Populist-metro")
DataLey <- readRDS(here("DataLeyes/DataNetaTotal.rds"))
...
#write.csv(DataLey, file="DataLeyFinal.csv", row.names = TRUE)
#write.xlsx(DataLey , file="DataLeyFinal.xlsx")
